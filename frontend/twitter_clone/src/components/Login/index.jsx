  ...
  return (
    <div className="flex h-screen bg-gray-900">
      <div className="flex-grow flex items-center justify-center">
        <form onSubmit={handleSubmit} className="p-6 rounded-lg w-96">
          <div className="absolute top-10">
            <FontAwesomeIcon
              icon={faTwitter}
              className="text-6xl text-twitter-blue"
            />
          </div>
          ...
          {!isLoginMode && !isResetPasswordMode ? (
            <p className="mb-8 text-sm">
              ...
              <span className="text-twitter-blue font-bold cursor-pointer hover:underline">
                Terms of Use
              </span>
            </p>
          ) : (
      ...
      <div className="w-5/12 hidden md:flex flex-col items-center justify-center bg-gray-800 text-white p-6">
        <h2 className="text-2xl text-center mb-4">It's what's happening</h2>
